...
# SQL 查询语句
sql = "SELECT `direct`,`name`,`sex`,`phone`,`qq`,`email`,`number`,`college`,`major`,`english_grade`,`math_grade`,`address` FROM application ORDER BY id asc"
...
title = [u"编号", u"姓名", u"性别", u"手机号", u"QQ号", u"邮箱",
